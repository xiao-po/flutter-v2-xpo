...
class RichTextConverter {
  ...
  static List<Widget> createBlockWidgetByType(RichTextContentElement element) {
    switch(element.type) {
      ...
      case ContentType.pre:  return createPreAreaWidget(element);break;
      case ContentType.code:  return createCodeAreaWidget(element);break;
      case ContentType.ol:  return createParagraphTree(element);break;
      case ContentType.ul:  return createParagraphTree(element);break;
      case ContentType.li:  return createParagraphTree(element);break;
      case ContentType.h1:  return createH1Widget(element);break;
      case ContentType.h2:  return createH2Widget(element);break;
      default:;
    }
  }
  ...
  static Widget createTextSpanByType(RichTextContentElement element) {
    switch(element.type) {
      ...
      case ContentType.span:  return createTextWidget(element);break;
      case ContentType.strong: return createStrongTextWidget(element); break;
      default: return Text("");
    }
    ...
    if (element.children != null && element.children.length > 0 ) {
      for (RichTextContentElement element in element.children) {
          if (element.isBlockElement()) {
            list.addAll(createParagraphChildren(element));
          } else {
